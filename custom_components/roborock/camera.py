...
DEFAULT_SIZES = {
    CONF_SIZE_VACUUM_RADIUS: 20, #6,
    CONF_SIZE_PATH_WIDTH: 4, #1,
    CONF_SIZE_MOP_PATH_WIDTH: 50, #12,
    CONF_SIZE_IGNORED_OBSTACLE_RADIUS: 18, #4,
    CONF_SIZE_IGNORED_OBSTACLE_WITH_PHOTO_RADIUS: 20, #4,
    CONF_SIZE_OBSTACLE_RADIUS: 20, #4,
    CONF_SIZE_OBSTACLE_WITH_PHOTO_RADIUS: 20, #4,
    CONF_SIZE_CHARGER_RADIUS: 20, #6,
}
