...
class ImageHandlerRoborock:
    ...
    COLORS = {
        ...
        COLOR_NO_MOPPING_ZONES: (0, 0, 0, 0),
        COLOR_NO_MOPPING_ZONES_OUTLINE: (0, 0, 0, 0),
        COLOR_CHARGER: (32, 33, 36),
        COLOR_CHARGER_OUTLINE: (0, 0, 0),
        COLOR_ROBO: (38, 38, 38),
        COLOR_ROBO_OUTLINE: (255, 0, 0),
        ...
        COLOR_ROOM_1: (0, 0, 0, 0),
        COLOR_ROOM_2: (0, 0, 0, 0),
        COLOR_ROOM_3: (0, 0, 0, 0),
        COLOR_ROOM_4: (0, 0, 0, 0),
        COLOR_ROOM_5: (0, 0, 0, 0),
        COLOR_ROOM_6: (0, 0, 0, 0),
        COLOR_ROOM_7: (0, 0, 0, 0),
        COLOR_ROOM_8: (0, 0, 0, 0),
        COLOR_ROOM_9: (0, 0, 0, 0),
        COLOR_ROOM_10: (0, 0, 0, 0),
        COLOR_ROOM_11: (0, 0, 0, 0),
        COLOR_ROOM_12: (0, 0, 0, 0),
        COLOR_ROOM_13: (0, 0, 0, 0),
        COLOR_ROOM_14: (0, 0, 0, 0),
        COLOR_ROOM_15: (0, 0, 0, 0),
        COLOR_ROOM_16: (0, 0, 0, 0)
    }
